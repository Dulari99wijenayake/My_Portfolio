...
const ArticleCard: React.FC<ArticleCardProps> = ({ article }) => {
  ...
  return (
    ...
    >
      ...
      <div className="p-6 flex flex-col flex-grow">
        <p className="text-sm font-semibold text-accent-green mb-1">{platform}</p>
  ...
  <p className="text-muted text-base mb-4 text-center leading-relaxed px-2">{description}</p>
        <div className="flex items-center text-accent-green font-semibold group-hover:underline mt-auto justify-end">
